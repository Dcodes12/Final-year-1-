...
function setup() {
	...
	angleMode(DEGREES)
	 ...
	 vis.add(new Needles());
	 vis.add(new TriangluarSpread())
	 vis.add(new OvalWaveSpikes());
	 vis.add(new VisualRipplePattern());
	 vis.add(new Musicsticks())
	 vis.add(new FlowLines());
	 vis.add(new CircleWavePatternsAndBits())
